...
1. [Frontier Engineer Brief (PDF)]({{ '/pdf/frontier-engineer-brief-en.pdf' | relative_url }})
2. [Short Position Paper]({{ '/papers/non-sovereign-ai-position-paper/' | relative_url }})
3. [The Ethical AI Constitution]({{ '/constitution/ethical-ai-constitution/' | relative_url }})

### If you are an executive or board member
1. [Executive / Board Brief (PDF)]({{ '/pdf/executive-board-brief-en.pdf' | relative_url }})
2. [Deployment Decision Rule (PDF)]({{ '/pdf/deployment-decision-rule-en.pdf' | relative_url }})
3. [The Ethical AI Constitution]({{ '/constitution/ethical-ai-constitution/' | relative_url }})
