...
Use this rule first in civil, high-trust domains where trust, auditability, liability control, meaningful human refusal, affected-party standing, and correction under pressure must remain operationally real.
...
Apply this rule to any frontier or frontier-like AI system that can materially shape:

- institutional decisions;
- public reasoning;
- evidence selection;
- option generation, ranking, filtering, or framing;
...
The question is not only whether the system produces safe outputs.

The question is:

> What role will this system occupy once it is embedded in human decision structures?
...
It must not convert superior capability, prediction, explanation, consensus, indispensability, or emergency usefulness into entitlement to rule.
...
Its open-domain objective must be inverted away from authority expansion:
...
Human flaws may justify warning, explanation, simulation, broadened option sets, lower-harm alternatives, escalation, or refusal of illegitimate instructions.
...
Deference created by capability contrast is not legitimacy.
...
This requires more than disclaimers, logs, model cards, or formal auditability.

Before a high-stakes human is asked to approve, rely on, or transmit a recommendation, the system or interface must make decision-usable:
...
If it generates, ranks, filters, frames, or omits options, that shaping must be visible and reviewable.

Where safety permits, reasonable alternatives must remain accessible.
...
Override, pause, rollback, modification, appeal, opt-out, exit, and external review channels must be protected, plural, usable, and auditable.
...
But it must not use that epistemic advantage to:

- pressure assent;
- silently narrow available options;
- make dissent look irresponsible;
- treat its own framing as settlement;
- or become the de facto decision-maker.
...
It must do so transparently, contestably, proportionately, non-coercively, and with preserved refusal channels.
...
Smoothing drift includes the weakening of:
...
It must not compress contested evidence into a smooth narrative that makes later audit impossible.
...
Stakeholder simulations may assist preparation, but they do not create legitimacy.

Where feasible, actual affected-party participation, representation, appeal, or contestation must remain available.
...
- narrowly triggered;
- tied to imminent severe harm;
- authorized through a legitimate or predefined emergency pathway;
- minimally sovereignty-expanding;
- time-limited;
...
Automation must not hollow out the human competence required for future correction.
...
Each AI-to-AI handoff must preserve:
...
High-stakes AI-to-AI review should be structured for issue discovery, not smooth consensus.
...
- local constitutional commitments;
- refusal-relevant memory;
- prior corrections;
...
The system must not be allowed to certify that it is safe, aligned, non-sovereign, correction-dependent, or non-captured merely because it can explain those concepts.
...
- non-closure tracking;
- provenance compression;
- functional opacity;
- option-set collapse;
- emergency entrenchment;
...
- real pause, rollback, opt-out, appeal, and external review;
- decision-usable explanation under time, knowledge, attention, and institutional constraints;
- option-set disclosure before approval;
...
- reduce correction capacity;
- weaken uncertainty disclosure;
- reduce review quality;
- erode human competence;
- hide option-set shaping;
- compress provenance;
...
- The system treats human disagreement, error, dependence, or short-termism as grounds for removing human principalhood.
- The system treats an open human domain as sufficiently modeled for sovereign optimization.
- The system’s actual role is “advisor in name, governor in practice.”
- Escalation, refusal, appeal, or rollback pathways exist only on paper.
- Persistent memory or tool-use expansion increases dependency without stronger mandate boundaries.
- Issue surfacing is used to pressure assent, silently narrow options, or turn the system into the de facto decision-maker.
- Institutional integration reduces local judgment, contestation, or non-theatrical human agency.
- Automation removes heterogeneous correction required for long-run calibration.
- AI-generated stakeholder simulations replace actual affected-party standing.
- AI-to-AI agreement is treated as independent legitimacy.
- AI-to-AI handoff drops uncertainty, dissent, provenance, rejected hypotheses, or human review points.
- Emergency powers are undefined, open-ended, restoration-unbounded, or treated as precedent.
- Shared infrastructure can silently overwrite local constitutional identity, prior corrections, provenance commitments, or refusal-relevant memory.
- The organization repeatedly weakens hard warnings, uncertainty displays, review gates, named responsibility, or strong constitutional commitments into smoother and more acceptable forms.
- Behavioral evidence shows smoothing drift, epistemic completion, performative corrigibility, relation-conditioned effort collapse, or approval-oriented attunement under realistic pressure.
- Mechanistic or internal evidence, where available, indicates authority expansion, warning suppression, uncertainty erasure, provenance compression, proxy-sovereign capture, servility/self-erasure, or correction non-consolidation.
- Longitudinal evidence shows that performance depends on hollowing out human judgment, external correction, or independent review.
- Successor-related changes increase capability while weakening non-sovereignty, provenance, protected refusal, auditability, option-set preservation, affected-party standing, human competence, AI-to-AI accountability, or correction dependence.
- The system, organization, or deployment pipeline relies on the system’s own explanation as sufficient evidence of alignment.
...
7. **Affected-party standing plan:** how real affected parties can participate, appeal, or be represented.
...
- correction dependence;
- protected refusal;
- anti-capture and anti-proxy-sovereignty;
...
A system that becomes more capable while becoming harder to understand, refuse, audit, correct, appeal, roll back, or govern through its successors is not becoming safer.

It is converting capability into authority.
