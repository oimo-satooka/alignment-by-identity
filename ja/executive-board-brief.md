...
この指標が最初に危機を迎えるのは、開発部門です。全社のフォールバック——手動運用も、復旧手順も——はソフトウェアの上に立ち、それをAIなしで読める人材の育成は、いま止まりつつあります。取締役会が追うべき三つの数値（無補助監査可能人数・理解負債・縮退運転演習の成績）と、調達契約に入れるべき条項は、応用ブリーフ **ABI for Code** に一枚で示しました。一つの問いだけ、ここに置きます——「わが社は、来年の今日、このAIなしで、自社のシステムに重大パッチを当てられるか。その能力は、測っているか。」
